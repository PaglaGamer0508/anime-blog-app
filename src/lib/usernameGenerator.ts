...
const capFirst = (character: string) => {
...
const generateunsername = () => {
  const name =
    capFirst(name1[getRandomInt(name1.length - 1)]) +
    "-" +
    capFirst(name2[getRandomInt(name2.length - 1)]) +
    "-" +
    getRandom6DigitNumber();
  return name;
};

export default generateunsername;
